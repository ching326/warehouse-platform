...
Route::middleware('authenticated')->group(function (): void {
    ...
    Route::get('/inventory/stock-counts', StockCountIndex::class)->name('stock-counts.index');
    Route::get('/inventory/stock-counts/create', StockCountCreate::class)->name('stock-counts.create');
    Route::get('/inventory/stock-counts/import', StockCountImport::class)->name('stock-counts.import');
    Route::get('/inventory/stock-counts/{stockCountRun}', StockCountShow::class)->name('stock-counts.show');
});
