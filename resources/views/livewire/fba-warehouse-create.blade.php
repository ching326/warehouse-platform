<div class="fba-warehouse-create-page">
    <form wire:submit="save" class="sku-form">
        <section class="table-shell flux-panel form-panel">
            <div class="form-panel-header">
                <div>
                    <strong>{{ __('setup.fba_warehouse_create_page_title') }}</strong>
        ...
        <div class="form-actions">
            ...
            <flux:button type="submit" variant="primary">{{ __('setup.btn_create_fba_warehouse') }}</flux:button>
        </div>
    </form>
</div>
