...
return [
    ...
    'filter_fulfillment' => 'Ship status',
    ...
    'col_shipping_tracking' => 'Shipping',
    ...
    'shipping_method_remap_no_default' => 'No SKU default shipping method is available for this order.',
    'shipping_method_remap_tie' => 'Shipping method could not be remapped because multiple SKU defaults have the same priority.',
    ...
    'btn_remap_shipping_method' => 'Remap shipping',
    ...
    'release_hold_before_mark_ready' => 'Release the hold before marking this order ready.',
    ...
    'bulk_ready_result_no_skips' => ':updated order(s) marked ready.',
    ...
    'reship_in_progress' => 'Reship requested',
    'reshipped' => 'Reshipped',
    ...
    'ready_select_warehouse' => 'Select a warehouse before arranging fulfillment.',
    'ready_combine_title' => 'Arrange fulfillment',
    'ready_combine_message' => 'Multiple shipments found for the same recipient and address. Combine or keep separate?',
    'ready_unfulfilled_suggestion' => ':count matching unfulfilled order(s) are not ready yet and will not be grouped.',
    'ready_combine_confirm' => 'Combine',
    'ready_arrange_confirm' => 'Arrange',
    'ready_combine_decline' => 'Separate orders',
    'import_page_title' => 'Import Sales Orders',
    'import_page_subtitle' => 'Upload a CSV or XLSX file to create orders in bulk.',
    'import_btn' => 'Import',
    'import_orders_menu' => 'Orders',
    'import_file_upload' => 'File Upload',
    'import_paste_grid' => 'Paste Grid',
    'import_amazon_api' => 'Amazon API',
    'import_manual_input' => 'Manual Input',
    'import_courier_menu' => 'Courier',
    'import_tracking_numbers' => 'Import tracking no.',
    ...
    'paste_import_page_title' => 'Paste Sales Orders',
    'paste_import_page_subtitle' => 'Paste spreadsheet rows from WeChat Docs, Excel, or Google Sheets.',
    'paste_import_grid_title' => 'Import Grid',
    'paste_import_grid_subtitle' => 'Paste copied spreadsheet rows, choose column meanings, and preview before import.',
    'paste_import_hint' => 'Click any cell, then paste copied spreadsheet cells. If you paste at A2, data starts at A2.',
    'paste_import_preview_btn' => 'Preview import',
    'paste_import_clear_btn' => 'Clear grid',
    'paste_import_missing_mapping' => 'Map the order ID, SKU, and quantity columns before previewing.',
    'paste_import_mapping_heading' => 'Column mapping',
    'paste_import_mapping_hint' => 'Choose what each spreadsheet column means. Save a template so you do not need to map it again.',
    'paste_import_column_mapping_hint' => 'Use the dropdown under each spreadsheet column to choose what that column means.',
    'paste_import_column_map_short' => 'Map',
    'paste_import_column_ignore' => '-- ignore --',
    'paste_import_template_load' => 'Saved template',
    'paste_import_template_select' => 'Select template',
    'paste_import_template_load_btn' => 'Load template',
    'paste_import_template_name' => 'Template name',
    'paste_import_template_save_btn' => 'Save template',
    'paste_import_template_default' => 'Use as default template for this tenant',
    'paste_import_template_loaded' => 'Template loaded.',
    'paste_import_template_saved' => 'Template saved.',
    'paste_import_template_default_saved' => 'Default template saved.',
    'paste_import_template_default_requires_saved' => 'Load or save a template before setting it as default.',
    'paste_import_template_name_required' => 'Enter a template name.',
    ...
    'tracking_import_title' => 'Import tracking numbers',
    'tracking_import_subtitle' => 'Upload a Yamato or Sagawa CSV/TXT file. Orders are matched by platform order ID.',
    'tracking_import_close_btn' => 'Close',
    ...
    'tracking_import_succeeded' => 'Tracking numbers imported.',
    ...
    'shipping_notice_menu' => 'Shipping Notices',
    'bulk_status_group' => 'Status',
    'chip_platform' => 'Platform',
    'chip_shop' => 'Shop',
    'chip_fulfillment' => 'Ship status',
    ...
    'btn_export_amazon_ship_notice' => 'Amazon Ship Notice',
    'btn_export_rakuten_ship_notice' => 'Rakuten Ship Notice',
    ...
    'marketplace_notice_export_blocked' => 'Marketplace shipping notice export is blocked. Please fix the selected orders, then try again.',
    ...
    'marketplace_notice_export_missing_mapping' => 'Some selected orders use a shipping method that has no Amazon/Rakuten carrier mapping.',
    'marketplace_notice_export_missing_carrier_code' => 'Some selected orders use a shipping method whose Amazon/Rakuten mapping has no carrier code.',
    ...
    'btn_cancel_pending_export' => 'Cancel',
    'marketplace_notice_exported' => 'Marketplace shipping notice exported.',
    'marketplace_notice_export_missing_ids' => 'Missing or unauthorized order IDs: :ids.',
    'marketplace_notice_export_mixed_tenant_ids' => 'Mixed tenant order IDs: :ids.',
    'marketplace_notice_export_mixed_platform_ids' => 'Mixed platform order IDs: :ids.',
    'marketplace_notice_export_wrong_platform_ids' => 'Wrong platform order IDs: :ids.',
    'marketplace_notice_export_blocked_status_ids' => 'Blocked status order IDs: :ids.',
    'marketplace_notice_export_missing_platform_order_ids' => 'Missing platform order IDs: :ids.',
    'marketplace_notice_export_missing_shipping_method_ids' => 'Missing shipping method order IDs: :ids.',
    'marketplace_notice_export_missing_tracking_ids' => 'Missing tracking order IDs: :ids.',
    'marketplace_notice_export_missing_mapping_ids' => 'Orders cannot be exported because their shipping method is not mapped for this marketplace. Go to Setup > Shipping Methods, open the shipping method used by these orders, and add an Amazon/Rakuten marketplace mapping with a carrier code.',
    'marketplace_notice_export_missing_carrier_code_ids' => 'Orders cannot be exported because their shipping method marketplace mapping has no carrier code. Go to Setup > Shipping Methods, open the shipping method used by these orders, and fill in the carrier code.',
    'marketplace_notice_export_no_ready_lines_ids' => 'No ready lines order IDs: :ids.',
    ...
    'courier_export_blocked' => 'Courier export is blocked. Please fix the selected orders, then try again.',
    ...
    'courier_export_blocked_status_ids' => 'Orders cannot be exported because they are on hold, cancel requested, or cancelled.',
    'courier_export_no_ready_lines_ids' => 'Orders cannot be exported because they have no ready-to-ship lines.',
    ...
    'bulk_delete_confirm' => 'Delete the selected orders? This cannot be undone.',
    'bulk_hold_result' => ':updated order(s) put on hold. :skipped skipped.',
    'bulk_hold_result_no_skips' => ':updated order(s) put on hold.',
    'bulk_release_hold_result' => ':updated order(s) released from hold. :skipped skipped.',
    'bulk_release_hold_result_no_skips' => ':updated order(s) released from hold.',
    'bulk_cancel_result' => ':updated order(s) cancelled. :skipped skipped.',
    'bulk_cancel_result_no_skips' => ':updated order(s) cancelled.',
    'bulk_delete_result' => ':updated order(s) deleted. :skipped skipped.',
    'bulk_delete_result_no_skips' => ':updated order(s) deleted.',
];
