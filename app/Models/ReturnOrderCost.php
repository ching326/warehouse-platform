...
class ReturnOrderCost extends Model
{
    ...
    public static function costTypeOptions(): array { return collect([self::COST_FREIGHT_COLLECT, self::COST_INSPECTION, self::COST_RESTOCKING, self::COST_DISPOSAL, self::COST_RESEND_SHIPPING, self::COST_OTHER])->mapWithKeys(fn ($v) => [$v => __('return_orders.cost_types.'.$v)])->all(); }
}
