...
class FbaWarehouseCreate extends Component
{
    ...
    public function save()
    {
        ...
        FbaWarehouse::create($this->payload());

        session()->flash('status', __('setup.fba_warehouse_created'));
    ...
    {
        return view('livewire.fba-warehouse-create', [
            'countries' => $this->countryOptions(),
            'statuses' => $this->statusOptions(),
        ])->layout('inventory', [
            'title' => __('setup.fba_warehouse_create_page_title'),
    ...
    private function validateInput(): void
    {
        validator($this->validationData(), [
            ...
            'code' => [
                ...
                'string',
                'max:50',
                Rule::unique('fba_warehouses', 'code')->where('country_code', $this->countryCode),
            ],
