...
class FeeRateCreate extends Component
{
    ...
    public function save()
    {
        ...
        FeeRate::query()->create($data);

        session()->flash('status', __('billing.fee_rate_created'));
    ...
    {
        return view('livewire.fee-rate-create', [
            'tenants' => $this->tenantOptions(),
            'feeTypes' => $this->feeTypeOptions(),
            'units' => $this->unitOptions(),
            'usesMarkup' => $this->usesMarkup(),
        ])->layout('inventory', [
            'title' => __('billing.fee_rate_create_page_title'),
